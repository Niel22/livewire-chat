    ...
    <div class=" flex flex-col overflow-y-scroll grow h-full">
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 border-b z-10 bg-white dark:bg-gray-800 border-gray-200 dark:border-black">
            <div class="flex w-full items-center px-2 lg:px-4 py-2 gap-2 md:gap-5">
                ...
                <div class="shrink-0">
                    <x-avatar class="h-9 w-9 md:w-11 md:h-11" />
                </div>
        ...
        <main class="flex flex-col gap-3 p-2 overflow-y-auto flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
            <div @class([
                ...
                <div @class(['flex flex-wrap text-[15px] rounded-lg p-2 flex flex-col text-black bg-[#f6f6f8fb]',
                    'rounded-bl-none border border-gray-200/48 bg-transparent dark:border-black text-gray-800 dark:text-gray-200' => false,
                    'rounded-br-none bg-blue-500 text-gray-800 dark:text-gray-200'=> true 
                ])>

                <p class="whitespace-normal text-sm md:text-base tracking-wide md:tracking-normal">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis amet, est officiis quia rem exercitationem iste suscipit eveniet aliquid repellat enim dolor temporibus mollitia laborum corporis, molestias tempora at voluptatem.
                </p>

                <div class="ml-auto flex gap-2">
                    <p @class([
                        'text-xs', 'text-gray-500 dark:text-gray-200' => false,
                ...
                <form method="POST" autocapitalize="off"> 
                    ...
                    <div class="grid grid-cols-12">
                        <input type="text" autocomplete="off" autofocus placeholder="Write your message here"
                            maxlength="1700"
                            class="col-span-10 bg-gray-100 border-0 outline-none focus:border-0 focus:ring-0 rounded-lg hover:ring-0 focus:outline-none"
                        >

                        <button type="submit" class="col-span-2 text-gray-800 dark:text-gray-200">Send</button>
                    </div>
                </form>
