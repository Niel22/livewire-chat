<div 
    ...
    <header class="px-3 z-10 bg-white dark:bg-gray-800 sticky top-0 w-full py-2">
        ...
        <div class="border-b border-gray-200 dark:border-black justify-between flex items-center pb-2">

            <div class="flex items-center gap-2">
                <h5 class="font-extrabold text-gray-800 dark:text-gray-200 text-2xl">Chats</h5>
            </div>
            <button>
                <svg class="w-7 h-7 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M6 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5m-2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
                </svg>
            </button>
        </div>

        <div class="flex gap-3 items-center overflow-x-scroll hide-scrollbar text-gray-800 dark:text-gray-200 p-2 bg-white dark:bg-gray-800">
            <button @click="type='all'" :class="{'bg-blue-100 border-none text-black' :type=='all'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 md:px-5 py-1 lg:py-2.5 border">
                All
            </button>
            <button @click="type='deleted'" :class="{'bg-blue-100 border-none text-black' :type=='deleted'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 md:px-5 py-1 lg:py-2.5 border">
                Deleted
            </button>
        </div>
    </header>
                    ...
                    <aside class="grid grid-cols-12 w-full">
                        ...
                        <div class="col-span-1 flex flex-col text-center my-auto">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical text-gray-800 dark:text-gray-200" viewBox="0 0 16 16">
                                ...
                                <x-slot name="content">
                                    <div class="w-full">
                                        ...
                                        <button 
                                            ...
                                            wire:click="deleteByUser('{{ encrypt($convo->id) }}')"
